...
*
*  Last review done by @Cult at May 2020: done chage of 'size' with lenght for compatibility with JQuery 3.4.x
*  Change for BNCF: lines 259-263, now it not works for 'any_bc' index
*/
(function($) {
  ...
  Autocomplete.prototype = {
    ...
    initialize: function() {
      ...
      this.killerFn = function(e) {
        if ($(e.target).parents('.autocomplete').lenght === 0) {
          me.killSuggestions();
          me.disableKillerFn();
        }
      };
