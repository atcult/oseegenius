...
public class FolioDailyItemDeleteServlet extends FolioLoanServlet {
	private static final long serialVersionUID = 167833553L;
	...
	protected void doGet(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
		...
		try {			
			...
			FolioResponseModel item = folioAPI.getPeriodicFromOpac(accessToken);			
...
//				}
//				userList = folioAPI.getUserList(folioAPI.searchFolioUserByQuery(accessToken, query, limit, offset));
//			}
