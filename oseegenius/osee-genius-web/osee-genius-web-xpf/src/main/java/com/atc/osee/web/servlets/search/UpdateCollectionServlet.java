...
/**
 * OseeGenius -W- save collection selected in session
 * 
 * @author Alice Guercio
 * @since 1.0
 */
public class UpdateCollectionServlet extends RememberLastVisitedResourceServlet 
{
	...
	{	
		request.setCharacterEncoding("UTF-8");	
		 try {
			...
			String collection = request.getParameter("collection_data");
