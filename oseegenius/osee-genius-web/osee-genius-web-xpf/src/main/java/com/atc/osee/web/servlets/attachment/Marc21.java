...
/**
 * MARC 21 attachment builder.
 * 
 * @author agazzarini
 * @since 1.0
 */
public class Marc21 extends AttachmentBuilder 
{
	@Override
	public String getContentType() 
	{
		return "application/octect-stream; charset=" + IConstants.UTF_8;
	}
			...
			final List<SolrDocument> documents) throws IOException, JRException
	{
		...
		MarcReader reader = null;
		 ...
		 try 
		 {
			 writer = new MarcStreamWriter(output, "UTF-8");
