...
/**
 * Hibernate class for view SBJCT_HDG_BRWS_IT_VW
 * @author carmen
 * @since 1.0
 */
public class SBJCT_HDG_BRWS_IT_VW extends Descriptor implements Serializable, SkipInFiling {
