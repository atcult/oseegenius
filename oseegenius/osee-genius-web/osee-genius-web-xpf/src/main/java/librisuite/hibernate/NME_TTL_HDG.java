...
import librisuite.business.cataloguing.bibliographic.NameTitleAccessPoint;
...
public class NME_TTL_HDG extends Descriptor {
	...
	/* (non-Javadoc)
	 * @see librisuite.business.descriptor.Descriptor#getAccessPointClass()
	 */
	...
	/* (non-Javadoc)
	 * @see librisuite.business.descriptor.Descriptor#getCategory()
	 */
	...
	/* (non-Javadoc)
	 * @see librisuite.business.descriptor.Descriptor#getCorrelationValues()
	 */
	...
	/* (non-Javadoc)
	 * @see librisuite.business.descriptor.Descriptor#getDefaultBrowseKey()
	 */
	...
	/* (non-Javadoc)
	 * @see librisuite.business.descriptor.Descriptor#getNextNumberKeyFieldCode()
	 */
	...
	/* (non-Javadoc)
	 * @see librisuite.business.descriptor.Descriptor#getReferenceClass()
	 */
	...
	/* (non-Javadoc)
	 * @see librisuite.business.descriptor.Descriptor#getSortFormParameters()
	 */
	...
	/* (non-Javadoc)
	 * @see librisuite.business.descriptor.Descriptor#setCorrelationValues(librisuite.business.common.CorrelationValues)
	 */
	...
	/* (non-Javadoc)
	 * @see librisuite.business.descriptor.Descriptor#getStringText()
	 */
	...
	/* (non-Javadoc)
	 * @see librisuite.business.descriptor.Descriptor#getDisplayText()
	 */
	...
	/* (non-Javadoc)
	 * @see librisuite.business.descriptor.Descriptor#getHeadingNumberSearchIndex()
	 */
	...
	/* (non-Javadoc)
	 * @see librisuite.business.descriptor.Descriptor#setStringText(java.lang.String)
	 */
	...
	public String getSortForm() {
		return nameHeading.getSortForm() + titleHeading.getSortForm();
	}
