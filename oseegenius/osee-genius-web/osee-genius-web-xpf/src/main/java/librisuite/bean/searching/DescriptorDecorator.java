...
public class DescriptorDecorator 
{
	...
	public void setCrossReferenceList(List crossReferenceList) {
		this.crossReferenceList = crossReferenceList;
	}
	...
	public String getCroppedHtmlText() {
	 ...
	 public String getHeadingType() {
			return concreteDescriptor.getHeadingType();
	}
	...
	public String getDisplayTextEscaped() {
		try {
			return URLEncoder.encode(concreteDescriptor.getDisplayText(), "UTF-8");	
		} catch (Exception e) {
			return concreteDescriptor.getDisplayText();
		}
	}
	...
	public String getVerificationLevelText() {
		String s = ValueLabelElement.decode(
			String.valueOf(getVerificationLevel()), getVerificationLevelList());
		return s;
	}
