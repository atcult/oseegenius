...
public class Defaults {
	...
	static public String getString(String key){
		//File file = new File("/home/alice/workspaces/oseegenius-1.2.demo.trento/1.2.demo.trento/osee-genius-web/osee-genius-web-distribution/target/osee-genius-web-distribution-1.2-imss/imss/WEB-INF");
		File file = null;
		try {
