...
import librisuite.business.authentication.PasswordExpiredException;
import librisuite.business.authentication.TooManyUsersException;
...
public class ColgateLoginResponse extends SocketMessage {
	 ...
	 * @exception PasswordExpiredException when password is expired
	 * @exception TooManyUsersException when logon is refused because there are too many
	 * concurrent users
	 */
