...
public interface AuthenticationBroker {
	 ...
	 * @param password
	 * The clear password of the user to be validated
	 * @return none
	 * @exception
	 * AuthenticationException (and sub-types) for specific authentication failures.
	 * @exception
	 * ConnectException if problems connecting to the authentication broker.
	 * @since 1.0
	 */	
	 ...
	 * @param oldPassword
	 * The clear password of the user (before the change)
	 * @param newPassword
	 * The new password to be applied (in the clear)
	 * @return none
	 * @exception
	 * AuthenticationException (and sub-types) for specific authentication failures.
	 * @exception
