 ...
 * - inserisce eng nel caso ci sia un $2 eng, oppure nel caso che $a inizi per asterisco
 * 
 ...
 * @since 1.2
 */
public class GetAlphaMultilanguageSubfieldsAsterisk extends TagHandler 
{
                ...
                if (dataField != null)
                {
                    ...
                    for (Subfield subfield : (List<Subfield>)dataField.getSubfields())
                    {
                        ...
                        if (Character.isLetter(code) && (skipSubfields == null || skipSubfields.indexOf(String.valueOf(code)) == -1))
                        {
                        	...
                        	if	(subfield.getCode() == 'a' && subfield.getData().charAt(0) == '*') {
