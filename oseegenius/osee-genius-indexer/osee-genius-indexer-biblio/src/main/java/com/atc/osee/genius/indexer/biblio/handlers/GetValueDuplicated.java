...
/**
 * A tag handler that extracts subfields in order as they appear in record 
 * 
 * 
 * @author aguercio
 * @since 1.2
 */
public class GetValueDuplicated extends TagHandler
{	
	@Override
							...
							final List<Subfield> subfields = field.getSubfields();
								if (subfields != null && !subfields.isEmpty())	{
									for (Subfield subfield : subfields) {
										...
										if (subFieldNamesString != null && subFieldNamesString.contains(subfield.getCode()+ "")) {
