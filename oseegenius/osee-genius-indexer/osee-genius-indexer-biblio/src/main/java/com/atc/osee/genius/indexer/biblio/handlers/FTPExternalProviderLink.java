 ...
 * @since 1.2
 */
public class FTPExternalProviderLink extends TagHandler implements IConstants
{
	@Override
	...
	{
		List<VariableField> _856s = record.getVariableFields("856");
		if (_856s != null)
		{
			for (VariableField f : _856s)
			{
				DataField _856 = (DataField) f;
				List<Subfield> subfields = _856.getSubfields('u');
				if (subfields != null)
				{
					for (Subfield subfield : subfields)
					{
						String data = subfield.getData();
						if (data != null && data.indexOf(tagMappings) != -1)
						{
							return data;
						}
					}
