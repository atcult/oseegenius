 ...
 * @since 1.0
 */
public final class RemovePartialPunctuationTagHandler extends Decorator
{
	
	
	
	public static void main(String[] args) {
		RemovePartialPunctuationTagHandler a = new RemovePartialPunctuationTagHandler();
		System.out.println(a.decorate("",(String)a.decorate("", "")));
	}
