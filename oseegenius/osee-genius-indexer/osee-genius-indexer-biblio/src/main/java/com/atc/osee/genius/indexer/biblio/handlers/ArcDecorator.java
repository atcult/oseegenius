 ...
 * @since 1.2
 */
public class ArcDecorator extends Decorator
{
	final String suffix = "ARC";
	...
	{
		System.out.println("PUNTO A " + value);
		Object result = (value != null && value.trim().length() > 0) ?  value + suffix : null;
		System.out.println("PUNTO B " + result);
		return result;
	}
}