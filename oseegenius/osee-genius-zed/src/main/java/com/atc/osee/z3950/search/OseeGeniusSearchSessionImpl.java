...
public class OseeGeniusSearchSessionImpl implements SearchSession, ApplicationContextAware {

  private static String UNKNOWN = "UNKNOWN";
  private String session_type = UNKNOWN;
  private String principal = null;
  private String session_id;
  private static Log log = LogFactory.getLog(OseeGeniusSearchSessionImpl.class);
  ...
  private OseeGeniusSearchSessionImpl() 
  {
   ...
   */
  protected OseeGeniusSearchSessionImpl(ProfileService profile_service,
                                        ...
                                        RecordFormatSpecification rfs) throws SearchException 
{
    ...
    Configuration configuration = (Configuration) ctx.getBean("JZKitConfig");
    ...
    try 
    {
    	...
    	if (sort_model != null)
	    {
	        ...
	        ((BackendSortDTO)sort_model).convert2SOLRAttributes(searchService.getServiceSpecificTranslations());	
	    }
	
      collection_ids = evaluateLandscape(landscape, configuration);
      ...
      for ( Iterator i = collection_ids.iterator(); i.hasNext(); ) {
        ...
        CollectionDescriptionDBO ci = configuration.lookupCollectionDescription(collection_dn);
      ...
      for ( Iterator rep_ids = queries_by_repository.keySet().iterator(); rep_ids.hasNext(); ) {
        ...
        // Create the subtask
        IRResultSet subtask = s.evaluate(query_to_send_to_this_repository, sort_model, null);
